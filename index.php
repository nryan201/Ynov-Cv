...
<header class="navbar">
    <div class="nav-left">
        <?php if (isset($_SESSION['username'])): ?>
            ...
            <a href="/projects" class="nav-link">Voir les Projets</a>
        <?php else: ?>
            <a href="/login" class="nav-link">Se connecter</a>
        <?php endif; ?>
        <!-- Le lien vers les profils publics est accessible à tous -->
        <a href="/public_profiles" class="nav-link">Profils Publics</a>
    </div>
    <div class="nav-right">
        <a href="contact.php" class="nav-link">Contact</a>
        <?php if (isset($_SESSION['username'])): ?>
            <a href="src/php/login/logout.php" class="nav-link">Déconnexion</a>
        <?php endif; ?>
    </div>
</header>
